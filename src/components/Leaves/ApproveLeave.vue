...
export default {
  ...
  methods: {
    fetchLeaveRequests() {
      axios.get('https://hope1.onrender.com/getLeaveRequests')
        .then(response => {
    ...
    ApproveLeave(leaveId) {
      ...
      axios.delete(`https://hope1.onrender.com/approveLeave/${leaveId}`)
        .then(response => {
     ...
     RejectLeave(leaveId) {
      ...
      axios.delete(`https://hope1.onrender.com/rejectLeave/${leaveId}`,{ data: { reason: reason } })
        .then(response => {
          console.warn(response)
          this.leaves = this.leaves.filter(leaves => leaves[1] !== leaveId);
        })
